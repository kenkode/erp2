            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                      ...
                      <li>
                        <a href="{{ URL::to('assets') }}"><i class="fa fa-building fa-fw"></i> Assets Management</a>
                    </li>
                    ...
                    <li>
                        <a href="{{ URL::to('journals/create') }}"><i class="fa fa-line-chart"></i> Depreciation</a>
                    </li>

                    <li>
                        <a href="{{ URL::to('Cashflow') }}"><i class="fa fa-money"></i> Cash Flow Statements</a>
                    </li>  
